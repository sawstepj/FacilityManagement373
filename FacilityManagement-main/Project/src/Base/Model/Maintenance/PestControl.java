...
public class PestControl extends MaintenanceRequest {
    int urgency;
    ...
    public PestControl(int u, String mainName, String rQ, int downTime, Location r, EmployeeType employeeType) {
        super(u, mainName, rQ, downTime, r, employeeType);

    String status = "Submitted";
    public PestControl(int u,String mainName, String rQ, int downTime,Location r) {
    ...
    public String employeeTyping() {
        return "Pest control performed by: " + employeeType.type();
    }
